...
#include <jni.h>
/* Header for class eu_aschuetz_nativeutils_impl_JNINativeMethod */

#ifndef _Included_eu_aschuetz_nativeutils_impl_JNINativeMethod
#define _Included_eu_aschuetz_nativeutils_impl_JNINativeMethod
#ifdef __cplusplus
extern "C" {
#endif
/*
